    ...
    await prisma.menuItem.createMany({
      data: [
        ...
        },
        {
          ...
          description: "Fried mozzarella, marinara sauce.",
          price: 8.99,
          categoryId: starters.id,
        },
        {
          name: "Crispy Calamari",
          description: "Fried calamari rings, lemon aioli.",
          price: 13.99,
          categoryId: starters.id,
        },
        {
          name: "Jalapeño Poppers",
          description: "Stuffed jalapeños, cheddar, ranch dip.",
          price: 9.99,
          categoryId: starters.id,
        },
        {
          name: "BBQ Chicken Quesadilla",
          description: "Grilled chicken, BBQ sauce, cheese, salsa.",
          price: 11.99,
          categoryId: starters.id,
        },
        ...
        {
          name: "Ribeye Steak",
          description: "12oz ribeye, garlic butter, fries.",
          price: 32.99,
          categoryId: grill.id,
        },
        {
        ...
        {
          name: "Grilled Salmon",
          description: "Atlantic salmon, lemon herb butter.",
          price: 24.99,
          categoryId: grill.id,
        },
        {
          name: "Chicken Skewers",
          description: "Marinated chicken, grilled veggies.",
          price: 17.99,
          categoryId: grill.id,
        },
        {
          name: "Smoked Brisket",
          description: "Texas-style beef brisket, pickles.",
          price: 29.99,
          categoryId: grill.id,
        },
        {
          name: "Grilled Veggie Platter",
          description: "Seasonal vegetables, balsamic glaze.",
          price: 15.99,
          categoryId: grill.id,
        },
        ...
        {
          name: "Classic Burger",
          description: "Beef patty, lettuce, tomato, onion, sauce.",
          price: 14.99,
          categoryId: burgers.id,
        },
        {
          name: "Bacon Cheeseburger",
          description: "Beef, bacon, cheddar, lettuce, tomato.",
          price: 16.99,
          categoryId: burgers.id,
        },
        {
          name: "Mushroom Swiss Burger",
          description: "Beef, sautéed mushrooms, Swiss cheese.",
          price: 15.99,
          categoryId: burgers.id,
        },
        {
          name: "Spicy Jalapeño Burger",
          description: "Beef, jalapeños, pepper jack, chipotle mayo.",
          price: 15.99,
          categoryId: burgers.id,
        },
        {
        ...
        },
        {
          ...
          description: "Pulled pork, BBQ sauce, slaw.",
          price: 15.49,
          categoryId: burgers.id,
        },
        ...
        {
          name: "Steak Salad",
          description: "Sliced steak, arugula, blue cheese, walnuts.",
          price: 16.99,
          categoryId: salads.id,
        },
        ...
        },
        {
          ...
          description: "Sweet potato fries, chipotle mayo.",
          price: 5.99,
          categoryId: sides.id,
        },
        {
        ...
        {
          name: "Mac & Cheese",
          description: "Cheesy baked macaroni.",
          price: 6.99,
          categoryId: sides.id,
        },
        ...
        {
          name: "Whiskey Sour",
          description: "Whiskey, lemon, sugar, bitters.",
          price: 10.99,
          categoryId: cocktails.id,
        },
        {
        ...
        {
          name: "Berry Smash",
          description: "Gin, berries, lemon, soda.",
          price: 10.49,
          categoryId: cocktails.id,
        },
        ...
        {
          name: "Apple Pie",
          description: "Warm apple pie, cinnamon, vanilla ice cream.",
          price: 6.99,
          categoryId: desserts.id,
        },
        {
          name: "Brownie Explosion",
          description: "Chocolate brownie, fudge, ice cream.",
          price: 7.49,
          categoryId: desserts.id,
        },
        ...
        {
          name: "Surf & Turf",
          description: "Grilled steak and shrimp, garlic butter.",
          price: 36.99,
          categoryId: specials.id,
        },
        {
          name: "BBQ Sampler Platter",
          description: "Ribs, brisket, wings, fries, slaw.",
          price: 39.99,
          categoryId: specials.id,
        },
        {
          name: "Ultimate Burger Challenge",
          description: "Triple patty burger, fries, shake.",
          price: 24.99,
          categoryId: specials.id,
        },
        {
          name: "Vegan Feast",
          description: "Grilled veggies, vegan burger, salad.",
          price: 21.99,
          categoryId: specials.id,
        },
      ],
